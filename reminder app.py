...
if __name__ == '__main__':
    ...
    send = tkinter.Button(app, text='Add task', fg="#000000", bg='green', height=3, width=30, command=get_entry)
    quit = tkinter.Button(app, text='Exit', fg="#ffffff", bg='red', height=3, width=30, command=app.destroy)
